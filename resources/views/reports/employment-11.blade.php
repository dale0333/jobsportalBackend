    ...
    <table>
        <tbody>
            ...
            @php
                ...
                // Include Direct as the first category
                ...
                // Count each direct sub-category
                $directCounts = [];
                foreach ($directs as $direct) {
                    $directCounts[$direct] = $records->where('category', $direct)->count();
                }

                // Count indirect categories for layout in Direct table
            ...
            <tr>
                ...
                <td class="text-center">
                    {{ collect($directs)->sum(fn($d) => $directCounts[$d]) }}
                </td>
                @foreach ($indirectCategories as $cat)
                    <td class="text-center"></td>
                @endforeach
            ...
            <tr>
                ...
                @foreach ($categories as $cat)
                    <td class="text-center">
                        {{ $genderCounts['Male'][$cat] + $genderCounts['Female'][$cat] }}
                    </td>
                @endforeach
    ...
    <div>
        ...
        <table style="text-align: center">
            ...
            <tr>
                ...
                <td tyle="padding: 2px; font-size: 12px">Position / Designation</td>
                <td tyle="padding: 2px; font-size: 12px">Contact Nos.</td>
                <td tyle="padding: 2px; font-size: 12px">Date Accomplished</td>
            </tr>
        </table>
        ...
        <div class="certification-statement">
            <i>
                ...
                the
                best of my knowledge and belief. I fully comprehend that any deliberate misrepresentation or dishonesty
                on
                my part may result in the rejection of this submission. I am fully aware of the legal provisions
                governing
                electronic document submission and acknowledge that any violation thereof may have legal consequences,
                including the potential refusal of this report.
            </i>
        </div>
